...
var test = function(req, res) {
	console.log('user 모듈 안에 있는 test 호출됨.');
	...
	if (database.db) {
		...
		database.UserModel.findAll(function(err, results) {
			...
			if (results) {
				//console.dir(results);
                var test_json =  { "나이" : "많임", "안뇽" : "그래안뇽", "age" : "1"};
...
var addUser = function(database, email, password, name, callback) {
	...
	// UserModel 인스턴스 생성
	var user = new database.UserModel({email:'wjdghks158@naver.com', password:'158774', name:'박정환'});
